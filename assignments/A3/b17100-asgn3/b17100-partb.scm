...
(define (myeval exp env)
  (cond ((self-evaluating? exp) exp)
        ((variable? exp) (if (thunk? (lookup-variable-value exp env)) (force-it (lookup-variable-value exp env))
...
(define (get-param arg)
  (if (check-lazy? arg)
      (cadr arg)
      arg))
(define (get-procedure-params-without-lazy args)
  (if (no-operands? args) '()
      (cons (get-param (first-operand args))
            (get-procedure-params-without-lazy (rest-operands args)))))
  ...
  (cond ((primitive-procedure? procedure)
        ...
        ((compound-procedure? procedure)
         (eval-sequence
           ...
           (extend-environment
             (get-procedure-params-without-lazy (procedure-parameters procedure))
...
(define (list-of-delayed-args exps formal-parameters env)
  (if (no-operands? exps) '()
      (cons (dispatch (first-operand exps) (car formal-parameters) env) 
            (list-of-delayed-args (rest-operands exps) (cdr formal-parameters) env))))
